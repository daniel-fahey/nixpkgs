...
let
  ...
  vllm-flash-attn' = lib.defaultTo (stdenv.mkDerivation {
    ...
    src = fetchFromGitHub {
      ...
      rev = "8e1b01d56210dc72030a2d0d41c2d8d266ba6309";
      hash = "sha256-jkJ1jgwLjckxS0U8m0OdU1qZkDZWpzp7+Hsx9MZgvm0=";
    };
...
buildPythonPackage rec {
  ...
  src = fetchFromGitHub {
    ...
    repo = "vllm";
    tag = "v${version}";
    hash = "sha256-odMn1yrZ+Fquw0OLDsiRKfpKfGoNoFBgvQLq+fMyWMM=";
  };
